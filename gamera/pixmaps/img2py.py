...
def main(args):
    ...
    if not append:
        ...
        out.write("try:\n")
        out.write("   from gamera.gui import compatibility\n")
        out.write("   wxImageFromStream = compatibility.create_image_from_stream\n")
        out.write("   wxBitmapFromImage = compatibility.create_bitmap_from_image\n")
